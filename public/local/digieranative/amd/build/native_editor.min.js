define(['exports'],(function(exports){'use strict';// ::- Persistent data structure representing an ordered mapping from
...
function validateNodeAttrs(type, attrs = {}) {
...
function validateMarkAttrs(type, attrs = {}) {
...
var Append = /*@__PURE__*/(function (RopeSequence) {
  ...
  return Append;
}(RopeSequence));// Recovery values encode a range index and an offset. They are
...
*/
const redo$1 = buildCommand(true, true);var base = {
  8: "Backspace",
  9: "Tab",
  10: "Enter",
  12: "NumLock",
...
const windows$1 = typeof navigator != "undefined" && /Win/.test(navigator.platform);
    ...
    return function (view, event) {
        ...
        if (name.length == 1 && name != " ") {
            ...
            if ((event.altKey || event.metaKey || event.ctrlKey) &&
                ...
                !(windows$1 && event.ctrlKey && event.altKey) &&
...
*/
const baseKeymap = mac$1 ? macBaseKeymap : pcBaseKeymap;const domIndex = function (node) {
...
}function fromNativeDocument(documentJson) {
    if (
        documentJson === null ||
...
function createRibbon({
    ...
    return ribbon;
}function createEditorState(documentJson) {
    if (
        documentJson === null ||
        typeof documentJson !== 'object' ||
        Array.isArray(documentJson)
...
}exports.commands=commands;exports.createAutosaveController=createAutosaveController;exports.createEditorState=createEditorState;exports.fromNativeDocument=fromNativeDocument;exports.mount=mount;exports.schema=schema;exports.toNativeDocument=toNativeDocument;exports.validateMarkAttrs=validateMarkAttrs;exports.validateNodeAttrs=validateNodeAttrs;Object.defineProperty(exports,Symbol.toStringTag,{value:'Module'});}));